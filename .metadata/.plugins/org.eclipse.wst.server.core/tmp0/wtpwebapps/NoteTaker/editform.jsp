...
<div class="form-card">
<h1 class="page-header">EDIT YOUR NOTE</h1>
<form action="UpdateNotesServlet" method="post" class="contact-form" novalidate>

	<input name ="noteId" value=<%=note.getId() %> type="hidden"/>
		
<div class="form-group">
<label for="title">TITLE</label>
<input type="text" required id="title" name="title" placeholder="" value=<%=note.getTitle() %> />
...
<!-- TEXT AREA DOESN'T CONTENT VALUE ATTRIBUTE -->

<textarea id="content" required name="content" rows="3"><%=note.getContent() %></textarea>
<div class="error" aria-live="polite"></div>
</div>
